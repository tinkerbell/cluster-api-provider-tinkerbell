...
func (in *TinkerbellClusterSpec) DeepCopyInto(out *TinkerbellClusterSpec) {
	*out = *in
	if in.ControlPlaneHardwareIDs != nil {
		in, out := &in.ControlPlaneHardwareIDs, &out.ControlPlaneHardwareIDs
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.MachineHardwareIDs != nil {
		in, out := &in.MachineHardwareIDs, &out.MachineHardwareIDs
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
